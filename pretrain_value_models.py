...
from trainer.pretrain_trainer import pretrain_model_trainer
...
def import_parameters(var_kwargs=None, mode="multistep_rl_flow_parameters"):
    ...
    if mode == "multistep_rl_flow_parameters":
        ...
        hyperparameters["mode"] = "pretrain_guided_flow"
    else:
...
def train(**var_kwargs):
    ...
    trainer = pretrain_model_trainer(
    ...
    trainer.pretrain(num_epochs=100, num_steps_per_epoch=10000)
