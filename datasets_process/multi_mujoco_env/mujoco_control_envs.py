...
from .half_cheetah_vel import HalfCheetahVelEnv as HalfCheetahVelEnv_
from .half_cheetah_dir import HalfCheetahDirEnv as HalfCheetahDirEnv_
from .ant_dir import AntDirEnv as AntDirEnv_
...
class AntDirEnv(AntDirEnv_):
    def __init__(self, tasks: List[dict], n_tasks: int = None, include_goal: bool = False):
        ...
        self.set_task_idx(0)
        self._max_episode_steps = 200
        self.task_description = f"The target direction is {self._task['goal']}."
